---
name: new-bundle
description: Create a new BKR bundle for a topic. Use when the user wants to add a new topic/area to the knowledge base.
---
...
2. Run `bun run new-bundle <name> "<one-line scope>"` — scaffolds from
